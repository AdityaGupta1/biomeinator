...
#define ADD_OPTION(name, desc, type, defaultValue)                                                                     \
    ...
    ADD_OPTION("skyStrength", "Sky strength excluding sun", float, "1.3");
    ADD_OPTION("clouds", "Clouds", bool, "true");
    ADD_OPTION("cloudCoverage", "Coverage", float, "0.3");
    ADD_OPTION("cloudDensity", "Extinction", float, "0.002");
    ADD_OPTION("cloudBaseHeight", "Base height (blocks)", float, "3000");
    ADD_OPTION("cloudThickness", "Thickness (blocks)", float, "512");
    ADD_OPTION("cloudCellSize", "Cell size (blocks)", float, "1024");
    ADD_OPTION("cloudPeriod", "Pattern scale (blocks)", float, "4096");
    ADD_OPTION("cloudSeed", "Pattern seed", uint32_t, "0");
    ADD_OPTION("cloudMaxDistance", "Draw distance (blocks)", float, "100000");
    ADD_OPTION("cloudMarchDistance", "Shadow distance in layer (blocks)", float, "9000");
    ADD_OPTION("cloudSamples", "Lighting samples per cloud interval", uint32_t, "4");
    ADD_OPTION("cloudAmbientEnabled", "Ambient lighting", bool, "true");
    ADD_OPTION("cloudAmbient", "Ambient strength", float, "0.8");
    ADD_OPTION("cloudPhaseG", "Anisotropy", float, "0.65");
    ADD_OPTION("cloudMultiScatter", "Multiple scattering", bool, "true");
    ADD_OPTION("cloudMultiScatterStrength", "Multiple scattering strength", float, "1");
    ADD_OPTION("cloudWindX", "Wind X (blocks/s)", float, "10");
    ADD_OPTION("cloudWindZ", "Wind Z (blocks/s)", float, "50");
    ADD_OPTION("cloudSer", "Reorder cloud rays", bool, "false");
...
#define COPY_SETTING(name, type) settings[name] = parseResult[name].as<type>()
    ...
    COPY_SETTING("cloudAmbientEnabled", bool);
