...
#define ADD_OPTION(name, desc, type, defaultValue)                                                                     \
    ...
    ADD_OPTION("cloudHeightRampEnd", "Top ramp end", float, "0.177273");
    ADD_OPTION("cloudHeightGain", "Top influence", float, "6.1");
    ADD_OPTION("cloudBottomWidth", "Bottom fraction", float, "0.042857143");
    ADD_OPTION("cloudBottomGain", "Bottom influence", float, "0.4");
    ADD_OPTION("cloudDensityRampStart", "Density ramp white", float, "0.086363539");
    ADD_OPTION("cloudDensityRampEnd", "Density ramp black", float, "0.359090865");
    ADD_OPTION("cloudAmbient", "Sky ambient", float, "0.68");
