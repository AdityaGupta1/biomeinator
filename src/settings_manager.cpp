...
#define ADD_OPTION(name, desc, type, defaultValue)                                                                     \
    ...
    ADD_OPTION("cloudThickness", "Thickness (blocks)", float, "256");
    ADD_OPTION("cloudCellSize", "Cell size (blocks)", float, "512");
    ADD_OPTION("cloudPeriod", "Pattern scale (blocks)", float, "8192");
    ...
    ADD_OPTION("cloudSamples", "Lighting samples per cloud interval", uint32_t, "1");
