...
#define ADD_OPTION(name, desc, type, defaultValue)                                                                     \
    ...
    ADD_OPTION("cloudDensity", "Extinction", float, "0.004");
    ...
    ADD_OPTION("cloudMaxDistance", "Draw distance (blocks)", float, "80000");
    ...
    ADD_OPTION("cloudVoronoiSmoothness", "Smooth F1 smoothness", float, "1");
    ADD_OPTION("cloudVoronoiRandomness", "Cell randomness", float, "0.666667");
    ADD_OPTION("cloudFineScale", "Noise scale", float, "30");
    ADD_OPTION("cloudFineDetail", "Noise detail", float, "2");
    ADD_OPTION("cloudFineRoughness", "Noise roughness", float, "0.5");
    ADD_OPTION("cloudFineStrength", "Strength", float, "0.05");
    ADD_OPTION("cloudHeightRampEnd", "Top ramp end", float, "0.257");
    ADD_OPTION("cloudHeightGain", "Top influence", float, "6.1");
    ADD_OPTION("cloudBottomWidth", "Bottom fraction", float, "0.044");
    ADD_OPTION("cloudBottomGain", "Bottom influence", float, "0.4");
    ADD_OPTION("cloudDensityRampStart", "Density ramp white", float, "0.086364");
    ADD_OPTION("cloudDensityRampEnd", "Density ramp black", float, "0.359091");
    ADD_OPTION("cloudAmbient", "Sky ambient", float, "0.8");
    ADD_OPTION("cloudPhaseG", "Anisotropy", float, "0.65");
    ADD_OPTION("cloudWindX", "Wind X (blocks/s)", float, "8");
    ADD_OPTION("cloudWindZ", "Wind Z (blocks/s)", float, "3");
    ADD_OPTION("cloudWarpTime", "Distortion time", float, "0");
    ADD_OPTION("cloudWarpSpeed", "Distortion speed", float, "0.02");
    ADD_OPTION("cloudVoronoiTime", "Cell time", float, "0");
    ADD_OPTION("cloudVoronoiSpeed", "Cell speed", float, "0.01");
    ADD_OPTION("cloudFineTime", "Detail time", float, "0");
    ADD_OPTION("cloudFineSpeed", "Detail speed", float, "0.05");
    ADD_OPTION("cloudStepSize", "View step (blocks)", float, "70");
    ADD_OPTION("cloudSecondaryStepSize", "Broad ray step (blocks)", float, "280");
    ADD_OPTION("cloudLightStepSize", "Sun step (blocks)", float, "750");
...
#define COPY_SETTING(name, type) settings[name] = parseResult[name].as<type>()
    ...
    COPY_SETTING("cloudMultiScatter", bool);
    ...
    COPY_SETTING("cloudMarchDistance", float);
    ...
    COPY_SETTING("cloudBottomWidth", float);
    COPY_SETTING("cloudBottomGain", float);
    ...
    COPY_SETTING("cloudStepSize", float);
    COPY_SETTING("cloudSecondaryStepSize", float);
    COPY_SETTING("cloudLightStepSize", float);
