...
// BiomeNoiseField state is global; serialize seed switches and fills across server threads.
...
int main(int argc, char** argv)
{
    ...
    server.Get("/api/biomes", [](const httplib::Request& req, httplib::Response& res)
    {
        ...
        std::vector<Biome> biomes(numTexelsX * numTexelsZ);
        {
            ...
            BiomeNoiseField::fillBiomeRect(biomes.data(),
                                           glm::ivec2(x0, z0),
