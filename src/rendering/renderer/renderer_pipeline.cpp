...
void initRootSignature()
{
    ...
    // ===================================
    {
        ...
        temporalReuseParams[TEMPORAL_REUSE_PARAM_IDX(INSTANCE_DATAS)] = MAKE_PARAM(SRV, RT, INSTANCE_DATAS);
        temporalReuseParams[TEMPORAL_REUSE_PARAM_IDX(MATERIALS)] = MAKE_PARAM(SRV, RT, MATERIALS);
        temporalReuseParams[TEMPORAL_REUSE_PARAM_IDX(PER_TRI_DATAS)] = MAKE_PARAM(SRV, RT, PER_TRI_DATAS);
