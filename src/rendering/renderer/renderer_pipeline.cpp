...
static void initRootSignature()
{
    ...
    // ===================================
    {
        ...
        gbufferParams[GBUFFER_PARAM_IDX(PER_FACE_DATAS)] = MAKE_PARAM(SRV, RT, PER_FACE_DATAS);
        ...
        gbufferParams[GBUFFER_PARAM_IDX(TANGENTS)] = MAKE_PARAM(SRV, RT, TANGENTS);
        gbufferParams[GBUFFER_PARAM_IDX(PACKED_TERRAIN_VERTS)] = MAKE_PARAM(SRV, RT, PACKED_TERRAIN_VERTS);
    ...
    // ===================================
    {
        ...
        ptParams[PT_PARAM_IDX(PER_FACE_DATAS)] = MAKE_PARAM(SRV, RT, PER_FACE_DATAS);
        ...
        ptParams[PT_PARAM_IDX(TANGENTS)] = MAKE_PARAM(SRV, RT, TANGENTS);
        ptParams[PT_PARAM_IDX(PACKED_TERRAIN_VERTS)] = MAKE_PARAM(SRV, RT, PACKED_TERRAIN_VERTS);
