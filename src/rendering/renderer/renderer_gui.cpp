        ...
        if (renderState.voxelMode)
        {
            ...
            if (ImGui::CollapsingHeader("Cloud settings"))
            {
                ...
                if (ImGui::Button("Reset cloud defaults"))
                {
                    ...
                    SettingsManager::setAsFloat("cloudHeightRampEnd", 0.257f);
                    SettingsManager::setAsFloat("cloudHeightGain", 6.1f);
                    SettingsManager::setAsFloat("cloudBottomWidth", 0.044f);
                    SettingsManager::setAsFloat("cloudBottomGain", 0.4f);
                    SettingsManager::setAsFloat("cloudDensityRampStart", 0.086364f);
                    SettingsManager::setAsFloat("cloudDensityRampEnd", 0.359091f);
