...
RtTarget::RtTarget(const std::wstring& name, DXGI_FORMAT format, uint32_t debugOutputChannels, bool hasUav, bool hasSrv)
    : name(name), debugOutputChannels(debugOutputChannels), hasUav(hasUav), hasSrv(hasSrv)
{
