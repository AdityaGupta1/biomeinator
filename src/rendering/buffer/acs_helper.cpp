                              ...
                              ManagedBufferSection idxsBufferSection)
{
    ...
    buildInfo->geometryDesc = {
        ...
        .Triangles = {
            ...
            .IndexBuffer = hasIdxs ? idxsBufferSection.getBuffer()->getBufferGpuVirtualAddress() + idxsBufferSection.offsetBytes : 0,
            .VertexBuffer = {
                .StartAddress = vertsBufferSection.getBuffer()->getBufferGpuVirtualAddress() + vertsBufferSection.offsetBytes,
