...
as one position batch requesting all five natural-terrain fields: erosion, climate-selected
landform styles and world position all affect the shared terrain profile, so no subset of the
fields reproduces the height that chunk generation uses. The site still supplies the ninth sample, and
