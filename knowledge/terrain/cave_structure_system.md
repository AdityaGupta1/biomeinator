...
at the floor/ceiling **once per layer**. Air biome classification is deferred to
decorator candidates; the separate cave-air mask and retained coarse fields are
not used to choose structures.
